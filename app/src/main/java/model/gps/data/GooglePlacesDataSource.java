...
//import com.jwetherell.augmented_reality.activity.R;
...
//		key = res.getString(R.string.google_places_api_key);
		key = res.getString(R.string.browser);
...
//		icon = BitmapFactory.decodeResource(res, R.drawable.buzz);
	...
	public String createRequestURL(double lat, double lon, double alt, float radius, String locale) {
		try {
			Log.e("GooglePlacesDataSourceUrlllllllllll",URL + "location="+lat+","+lon+"&radius="+(radius*1000.0f)+"&types="+TYPES+"&sensor=true&key="+key);
