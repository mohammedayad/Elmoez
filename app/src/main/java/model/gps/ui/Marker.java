...
import model.gps.activity.AugmentedReality;
import model.gps.camera.CameraModel;
import model.gps.common.Vector;
import model.gps.data.ARData;
import model.gps.data.PhysicalLocation;
import model.gps.ui.objects.PaintableBoxedText;
import model.gps.ui.objects.PaintableCircle;
import model.gps.ui.objects.PaintableGps;
import model.gps.ui.objects.PaintableObject;
import model.gps.ui.objects.PaintablePoint;
import model.gps.ui.objects.PaintablePosition;
...
public class Marker implements Comparable<Marker> {
    ...
    //to get long and lat of the places around me
    private double latitude;
    private double longitude;


    //marker for google places data source
    ...
    //marker foe wiki data source
    public Marker(String name, double latitude, double longitude, double altitude, int color,String summary) {
        this.latitude=latitude;
        this.longitude=longitude;
        set(name, latitude, longitude, altitude, color,summary);
    }
    ...
    //for wiki data source
    public void set(String name, double latitude, double longitude, double altitude, int color,String summary) {
        if (name == null)
            throw new NullPointerException();
...
//getter and setter for summary field to wiki data source
...
//    getter and setter for long and lat of places around my location
